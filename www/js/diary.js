    ...
    //  url: "http://52.193.132.4/upload2/diary_index.php?userId=" + window.localStorage.getItem("userId"),
        ...
        success: function(data)
        {
            ...
            for(var i = 0; i < data.length; i++){
                str = str + "<h2 style='border-bottom:double 3px; padding-bottom:0px; margin-bottom:0px'>" + data[i].categoryName + "</h2>\n";
                str=str + "<div>";
                str = str + "<p style='text-align:right; margin-top:0px'>"+data[i].allPoint+"ヶ所中 " + data[i].visitedPoints.length+"ヶ所達成</p>\n";
                str = str + "<table width='100%'>\n";
                
                var points = data[i].visitedPoints;
                for(var j = 0; j < points.length; j++){
                    str = str + "<tr class='wrapperIndex'>\n";
/*                    str = str + "<td>"+points[j].pointId+"</td>\n";*/
                    str = str + "<td class='pointLinkIndex' colspan='2'><a class='diaryLink' id='p"+points[j].pointId+"' href='javascript:void(0)'>"+points[j].pointName+"</a></td><td></td><tr>\n";
                    str = str + "<tr><td class='dateTimeIndex' colspan='2'>"+points[j].visitedDateTime.substr(0,10)+"</td><td></td>\n";
                    str = str + "</tr>\n";
                }
                str = str + "</table>\n";
                str = str + "</div>";
...
/*    
    $("#picture2").click(function(){
       //alert(photoSrc); 
       document.getElementById(picture2a).href="photoSrc";
       document.getElementById(picture2).src="photoSrc";
    });
*/
});
...
//            document.getElementById("picture2a").href="data:image/jpeg;base64," + diary_t[0];
